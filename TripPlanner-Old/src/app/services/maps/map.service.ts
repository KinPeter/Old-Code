...
import { mapIcons } from '~/app/shared/map-icons';
declare let L;
...
export class MapService {
  ...
  public initMap(center: Coords, zoom: number) {
  ...
  public addMarker(loc: Coords, type: string, name: string) {
  ...
  public removeMarker(loc: Coords) {
    let latlng: LatLng;
  ...
  public drawPath(from: Coords, to: Coords) {
