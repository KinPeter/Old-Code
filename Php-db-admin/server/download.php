...
$csv_filename = 'links_db_'.date('Y-m-d').'.csv';

// create empty variable to be filled with export data
$csv_export = '';

// query to get data from database and get field number
$query = mysqli_query($link, "SELECT * FROM linksbase");
...
$query = mysqli_query($link, "SELECT * FROM linkstags");
$field = mysqli_field_count($link);
...
$query = mysqli_query($link, "SELECT * FROM linksconnections");
$field = mysqli_field_count($link);
